  ...
  <body onload="startTime(), resimGoster(-1)">
    ...
    <div class="arkamenu">
      <div class="container-fluid">
        <div class="baslik">
          <a href="index.html">Lütfü Orhun İNAN</a> <c>/Giriş</c>
        </div>
      </div>
    </div>
...
<div class="container-fluid" style="height:600px; background-image:url('Varlık 1 yeni.png');background-size:cover;background-repeat:no-repeat;transform: scaleX(-1);">
	<div id="box" style="height:600px;transform: scaleX(-1);">
		...
		<form method="post">
			<div style="font-size: 20px;padding-top:150px;color: white;">Giriş Yap</div>
			...
			<div class="row">
				...
				<div class="col">
						<a href="signup.php"><input id="button" style="text-align:center;" value="Üye Ol"></a><br><br>
				</div>
			</div>
		</form>
	</div>
